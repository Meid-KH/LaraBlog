<x-layout.admin>
  @slot('heading') {{ ucwords($category->name) }} @endslot
      ...
      <div class="space-y-6">
        <div>
          ...
          <input
            ...
            id="name" type="text" name="name" value="{{ $category->name }}">
        </div>
        <div>
          ...
          <input
            class="text-gray-800 text-sm rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full"
            id="slug" type="text" name="slug" value="{{ $category->slug }}">
        </div>
        <div>
          ...
          border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 
            ...
            name="description" id="description" rows="5">{{ $category->description }}</textarea>
        </div>
      </div>
